...
Route::middleware(['permission:unit.crud'])->group(function () {
    ...
    Route::post('/units/{unit}/upload-schedule', [UnitController::class, 'uploadScheduleDocument'])->name('units.upload-document-schedule');
    Route::post('/units/{unit}/upload-guideline', [UnitController::class, 'uploadGuidelineDocument'])->name('units.upload-document-guideline');
    Route::delete('/units/{unit}/delete-schedule', [UnitController::class, 'deleteScheduleDocument'])->name('units.delete-document-schedule');
