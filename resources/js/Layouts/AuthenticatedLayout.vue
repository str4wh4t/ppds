...
const navigation = [
    ...
    { name: 'Report', href: route('activities.report', { user: usePage().props.auth.user }), icon: ClipboardDocumentCheckIcon, current: route().current('activities.report'), method: 'get' },
