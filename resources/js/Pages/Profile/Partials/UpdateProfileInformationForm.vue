...
<template>
    <section>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-2">
            <div>
                <InputLabel for="username" value="Username" />

                <TextInput id="username" type="text" class="mt-1 block w-full" v-model="form.username" required readonly
            ...
            <div>
                ...
                <TextInput id="identity" type="text" class="mt-1 block w-full" v-model="form.identity" required readonly
