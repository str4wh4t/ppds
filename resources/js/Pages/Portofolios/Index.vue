...
<template>
            ...
            <div class="mt-6">
                <dl class="grid grid-cols-1 sm:grid-cols-2">
                    ...
                    <div class="border-t border-gray-100 px-4 py-6 sm:col-span-2 sm:px-0">
                        ...
                        <dd class="mt-1 text-sm leading-6 text-gray-700 sm:mt-2">Fugiat ipsum ipsum deserunt culpa aute
                            sint do
                            nostrud anim incididunt cillum culpa consequat. Excepteur qui ipsum aliquip consequat sint.
                            Sit id
                            mollit nulla mollit nostrud in ea officia proident. Irure nostrud pariatur mollit ad
                            adipisicing
    ...
    <!-- <ModalCreate :show="isCreate" @close="isCreate = false" @updateProps="replaceProps" />
    <ModalUpdate :stase="selectedItem" :show="isUpdate" @close="closeUpdate" @exitUpdate="closeUpdate"
