...
watch(
    ...
    (newValue, oldValue) => {
        ...
        if (newValue) {
            ...
            form.dosen_units = props.user.dosen_units ?? [];
        }
    },
    { immediate: true }
);
        ...
        <div id="innerModal" class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow">
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <form @submit.prevent="submit" class="mt-1 text-sm text-gray-600">
                    ...
                    <div class="mt-2">
                        <InputLabel for="dosen_units" value="Units" />

                        <MultiselectBasic class="mt-1 block w-full" :key="form.identity" :options="units"
                            v-model="form.dosen_units" />

                        <InputError class="mt-2" :message="form.errors.dosen_units" />
                    </div>
                    <div class="mt-2">
