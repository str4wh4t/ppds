...
const searchPosts = () => {
    router.get(route('activities.index', { user: usePage().props.auth.user }), { search: filters.value.search }, { replace: true });
};
                    ...
                    <tr v-for="(activity, index) in activities.data" :key="activity.id">
                        <td
                            ...
                            <div class="mt-1 flex flex-col text-gray-500 sm:block lg:hidden">
                                ...
                                <span>{{ $formatDate({ date: activity.start_date }) }} - {{ $formatDate({
                                    date:
                                        activity.end_date
                                })
                                    }}</span>
                        ...
                        <!-- <td
                            ...
                            <div class="flex justify-center items-center">
                                <CheckCircleIcon v-if="activity.is_approved" class="h-5 w-5 text-green-400"
                                    aria-hidden="true" />
